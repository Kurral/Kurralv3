...
from ABTester.storage import StorageBackend, create_storage_backend
from ABTester.storage.local_storage import LocalStorage
from ABTester.config import StorageConfig, get_storage_config
        ...
        if config.database_url:
            try:
                ...
                if self.metadata_service.is_available():
                    from ABTester.database.connection import create_tables
