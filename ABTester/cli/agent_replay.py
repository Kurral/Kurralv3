...
Usage: python -m ABTester.cli.agent_replay <run_id> or --latest
"""
...
from ABTester.models.kurral import KurralArtifact, ModelConfig, LLMParameters
...
from ABTester.replay import replay_artifact
...
def replay(run_id: Optional[str], latest: bool, artifacts_dir: Optional[str], verbose: bool):
    ...
    Examples:
        # Replay by run_id
        python -m ABTester.cli.agent_replay local_agent_1234567890
        
        # Replay latest
        python -m ABTester.cli.agent_replay --latest
    """
