...
Usage: python ABTester/replay.py <kurral_id> [--artifacts-dir <dir>]
   or: python -m ABTester.replay <kurral_id> [--artifacts-dir <dir>]
"""
...
from ABTester.agent_replay import replay_agent_artifact
import argparse
...
if __name__ == "__main__":
    ...
    if args.latest:
        ...
        print("Usage: python ABTester/replay.py <kurral_id> [--artifacts-dir <dir>]")
        print("   or: python -m ABTester.replay <kurral_id> [--artifacts-dir <dir>]")
        print("\nExample: python ABTester/replay.py 810c48c1-fc9c-4ec4-a4f5-7fb7ed86506d")
        print("   or: python ../ABTester/replay.py 810c48c1 (from level1agentK directory)")
