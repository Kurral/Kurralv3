...
```bash
# From the Kurral_tester directory
python Kurral_tester/replay.py <artifact_path>
```

**Example:**
```bash
cd d:\Kurral_tester
python Kurral_tester/replay.py agent1/artifacts/961061f9-8029-4949-a07e-11a028d75cc4.kurral
```
...
```bash
# From the Kurral_tester directory
python -m Kurral_tester.cli.replay_cmd <artifact_path>
```

**Example:**
```bash
cd d:\Kurral_tester
python -m Kurral_tester.cli.replay_cmd agent1/artifacts/961061f9-8029-4949-a07e-11a028d75cc4.kurral
```
...
### Replay by run_id
```bash
python Kurral_tester/replay.py --run-id local_run_graph_with_kurral_1763472818 --storage-path agent1/artifacts
```

### Replay latest artifact
```bash
python Kurral_tester/replay.py --latest --storage-path agent1/artifacts
```

### Replay with different LLM (B replay)
```bash
python Kurral_tester/replay.py agent1/artifacts/961061f9-8029-4949-a07e-11a028d75cc4.kurral --llm-client openai
```

### Replay with different model
```bash
python Kurral_tester/replay.py agent1/artifacts/961061f9-8029-4949-a07e-11a028d75cc4.kurral --current-model gpt-4-turbo
```

### Show diff between original and replay
```bash
python Kurral_tester/replay.py agent1/artifacts/961061f9-8029-4949-a07e-11a028d75cc4.kurral --diff
```

### Verbose output
```bash
python Kurral_tester/replay.py agent1/artifacts/961061f9-8029-4949-a07e-11a028d75cc4.kurral --verbose
```
...
- Make sure you're running from the `Kurral_tester` directory
