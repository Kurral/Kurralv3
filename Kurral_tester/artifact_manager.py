...
from Kurral_tester.storage import StorageBackend, create_storage_backend
from Kurral_tester.storage.local_storage import LocalStorage
from Kurral_tester.config import StorageConfig, get_storage_config
        ...
        if config.database_url:
            try:
                ...
                if self.metadata_service.is_available():
                    from Kurral_tester.database.connection import create_tables
