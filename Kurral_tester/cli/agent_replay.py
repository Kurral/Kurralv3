...
Usage: python -m Kurral_tester.cli.agent_replay <run_id> or --latest
"""
...
def replay(run_id: Optional[str], latest: bool, artifacts_dir: Optional[str], verbose: bool):
    ...
    Examples:
        # Replay by run_id
        python -m Kurral_tester.cli.agent_replay local_agent_1234567890
        
        # Replay latest
        python -m Kurral_tester.cli.agent_replay --latest
    """
